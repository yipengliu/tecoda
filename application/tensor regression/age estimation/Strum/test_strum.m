function [res]=test_strum(trainM,trainy,testM,testy,settings)
...
if enable_cv
    ...
    best = cross_validation_strum(trainM, trainy, settings, settings.epsilon);
...
for rep=1:10
    ...
    tic;
    [tW, errList] = Strum(trainM, trainy, best.alpha, best.beta, epsilon, 1000);
    runtime(rep)=toc;
    %% Predict
