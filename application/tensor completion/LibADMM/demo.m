...
L = mode_n_product(L,U1,1,'T');
L = mode_n_product(L,U2,2,'T');
L = mode_n_product(L,U3,3,'T');
...
X = mode_n_product(X,U1,1,'T');
X = mode_n_product(X,U2,2,'T');
X = mode_n_product(X,U3,3,'T');
...
X = t_product(randn(n1,r,n3),randn(r,n2,n3));
