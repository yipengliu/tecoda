function [model] = BCPF_IC(Y, varargin)
...
%%
% addpath(genpath('..\..\LibADMM\Functions\@ktensor\'));
warning off; 
...
ip = inputParser;
ip.addParameter('obs', ones(dimY), @(x) (isnumeric(x) || islogical(x)) );
